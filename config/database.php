...
return [
    ...
    */
    ...
    'default' => getenv('DB_CONNECTION') ?? env('DB_CONNECTION', 'mysql'),
    ...
    */
    ...
    'connections' => [
        ...
        'sqlite' => [
            ...
            'database' => getenv('DB_DATABASE') ?? env('DB_DATABASE', database_path('database.sqlite')),
            'prefix' => '',
            'foreign_key_constraints' => getenv('DB_FOREIGN_KEYS') ?? env('DB_FOREIGN_KEYS', true),
        ],
        ...
        'mysql' => [
            ...
            'database' => getenv('DB_DATABASE') ?? env('DB_DATABASE', 'forge'),
            'username' => getenv('DB_USERNAME') ?? env('DB_USERNAME', 'forge'),
            ...
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => getenv('MYSQL_ATTR_SSL_CA') ?? env('MYSQL_ATTR_SSL_CA'),
            ]) : [],
        ],
    ...
    */
    ...
    'redis' => [
        ...
        'options' => [
            ...
            'prefix' => getenv('REDIS_PREFIX') ?? env('REDIS_PREFIX', Str::slug(getenv('APP_NAME') ?? env('APP_NAME', 'laravel'), '_').'_database_'),
        ],

        'default' => [
            'url' => getenv('REDIS_URL') ?? env('REDIS_URL'),
